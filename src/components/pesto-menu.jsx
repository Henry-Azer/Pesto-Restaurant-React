          ...
          <div className="pizza">
            ...
            <div class="pizza-menu-item">
              <img class="diavola" src={diavola_pizza} alt="" />
                ...
                <p class="pizza-discreption">
                  ...
                  peperoncino,Salami(Italian cured sausage),mozzarella,fresh
            ...
            <div class="pizza-menu-item">
              <img class="quattro" src={quattro_fromaggi_pizza} alt="" />
                ...
                <p class="pizza-discreption">
                  Napolitan-style pizza with fresh tomato sauce,topped with a
                  mix of four kinds of cheese(mozzarella,fontina,gorgonzola and
                  parmigiano-reggiano).
                </p>
